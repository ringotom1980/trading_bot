...
EXPERIMENTAL_SEARCH_SEEDS: list[dict[str, Any]] = [
    {
        "name": "seed_macro_horizon_long_sma240_hold",
        "overrides": {
            ...
            "long_entry_filters": {
                "close_vs_sma240_pct": {"min": 0.010},
                "sma60_vs_sma240_pct": {"min": 0.000},
                "slope_60": {"min": 0.0},
                "rsi_14": {"max": 86.0},
            },
            ...
            "entry_confirm_score": 0.70,
            "exit_threshold": 0.20,
            "long_filter_fail_score": 0.20,
            "hold_min_score": 0.20,
            "reverse_threshold": 0.95,
            "reverse_gap": 0.20,
            "hard_stop_loss_pct": 0.070,
            "take_profit_pct": 0.0,
            "cooldown_bars": 96,
            "min_hold_bars": 96,
            "max_bars_hold": 7200,
    ...
    {
        "name": "seed_macro_horizon_long_sma480_hold",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "score_mode": "FILTER_ONLY",
            "feature_lookback_bars": 480,
            ...
            "long_allowed_regimes": ["TREND_UP", "RANGE"],
            "long_entry_filters": {
                "close_vs_sma480_pct": {"min": 0.000},
                "sma240_vs_sma480_pct": {"min": -0.010},
                "slope_120": {"min": 0.0},
                "rsi_14": {"max": 88.0},
            },
            "entry_threshold": 0.70,
    ...
    {
        "name": "seed_macro_horizon_short_sma240_hold",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "score_mode": "FILTER_ONLY",
            "feature_lookback_bars": 480,
            ...
            "short_entry_filters": {
                "close_vs_sma240_pct": {"max": -0.010},
                "sma60_vs_sma240_pct": {"max": 0.000},
                "slope_60": {"max": 0.0},
                "rsi_14": {"min": 14.0},
            },
            "entry_threshold": 0.70,
    ...
    {
        "name": "seed_macro_long_trend_hold",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "score_mode": "FILTER_ONLY",
            "long_enabled": True,
    ...
    {
        "name": "seed_macro_long_loose_stop_hold",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "score_mode": "FILTER_ONLY",
            "long_enabled": True,
    ...
    {
        "name": "seed_macro_long_trailing_proxy",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "score_mode": "FILTER_ONLY",
            "long_enabled": True,
    ...
    {
        "name": "seed_macro_long_breakout_hold",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "score_mode": "FILTER_ONLY",
            "long_enabled": True,
            ...
            "long_allowed_regimes": ["TREND_UP"],
            "long_entry_filters": {
                "close_vs_sma20_pct": {"min": 0.004},
                "close_vs_sma60_pct": {"min": 0.010},
                "slope_5": {"min": 45.0},
                "volume_ratio_20": {"min": 1.0},
            },
            "entry_threshold": 0.70,
            "entry_min_gap": 0.20,
            "entry_confirm_score": 0.70,
    ...
    },
    {
        ...
        "overrides": {
            ...
            "long_allowed_regimes": ["TREND_UP"],
            "long_entry_filters": {
                "close_vs_sma20_pct": {"max": -0.004},
                "close_vs_sma60_pct": {"min": 0.006},
                "rsi_14": {"max": 52.0},
                "volume_ratio_20": {"min": 0.80},
            },
            "entry_threshold": 0.58,
            "entry_min_gap": 0.12,
            "entry_confirm_score": 0.62,
            "exit_threshold": 0.42,
            "reverse_threshold": 0.74,
            "reverse_gap": 0.12,
            "hard_stop_loss_pct": 0.012,
    ...
    {
        "name": "seed_recent_long_momentum_pullback",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": True,
            "short_enabled": False,
    ...
    {
        "name": "seed_recent_long_breakout_fast",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": True,
            "short_enabled": False,
            "long_allowed_regimes": ["TREND_UP"],
            "long_entry_filters": {
                "close_vs_sma20_pct": {"min": 0.002},
                "close_vs_sma60_pct": {"min": 0.008},
                "slope_5": {"min": 35.0},
                "volume_ratio_20": {"min": 1.05},
            },
    ...
    {
        "name": "seed_short_only_swing_strong_downtrend",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": False,
            "short_enabled": True,
            ...
            "short_entry_filters": {
                "close_vs_sma60_pct": {"max": -0.012},
                "slope_10": {"max": -80.0},
                "macd_hist": {"max": -12.0},
                "volume_ratio_20": {"min": 0.90},
            },
            "entry_threshold": 0.72,
            "entry_min_gap": 0.18,
            "entry_confirm_score": 0.76,
            "exit_threshold": 0.34,
    ...
    {
        "name": "seed_short_only_swing_breakdown",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": False,
            "short_enabled": True,
    ...
    {
        "name": "seed_refined_short_breakdown_high_volume",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": False,
            "short_enabled": True,
            "short_allowed_regimes": ["TREND_DOWN"],
            "short_entry_filters": {
                "close_vs_sma20_pct": {"max": -0.010},
                "close_vs_sma60_pct": {"max": -0.014},
                "slope_5": {"max": -75.0},
                "slope_10": {"max": -70.0},
                "macd_hist": {"max": -50.0},
                "volume_ratio_20": {"min": 1.10},
            },
            "entry_threshold": 0.66,
            "entry_min_gap": 0.16,
            "entry_confirm_score": 0.70,
    ...
    {
        "name": "seed_refined_short_breakdown_fast_cut",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": False,
            "short_enabled": True,
            "short_allowed_regimes": ["TREND_DOWN"],
            "short_entry_filters": {
                "close_vs_sma20_pct": {"max": -0.008},
                "close_vs_sma60_pct": {"max": -0.012},
                "slope_5": {"max": -65.0},
                "macd_hist": {"max": -35.0},
                "volume_ratio_20": {"min": 1.00},
            },
            "entry_threshold": 0.68,
            "entry_min_gap": 0.16,
            "entry_confirm_score": 0.72,
    ...
    {
        "name": "seed_refined_short_breakdown_wide_runner",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": False,
            "short_enabled": True,
            "short_allowed_regimes": ["TREND_DOWN"],
            "short_entry_filters": {
                "close_vs_sma20_pct": {"max": -0.012},
                "close_vs_sma60_pct": {"max": -0.016},
                "slope_10": {"max": -80.0},
                "macd_hist": {"max": -60.0},
            },
            "entry_threshold": 0.64,
    ...
    {
        "name": "seed_long_only_swing_strong_uptrend",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": True,
            "short_enabled": False,
    ...
    {
        "name": "seed_long_only_trend_low_frequency",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": True,
            "short_enabled": False,
    ...
    {
        "name": "seed_long_only_breakout_hold",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": True,
            "short_enabled": False,
    ...
    {
        "name": "seed_short_only_downtrend_strict",
        "overrides": {
            "signal_mode": "TREND_FOLLOWING",
            "long_enabled": False,
            "short_enabled": True,
